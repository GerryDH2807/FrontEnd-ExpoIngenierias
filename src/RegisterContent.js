import './css/RegisterContent.css';
            ...
            <div className='row p-2'>
                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col d-flex justify-content-center'>
                                <Link to={'/Registro-estudiante'} className ="TextoValid3 text-center">Registrar estudiante</Link>
                            </div>
                        </div>
                ...
                <div className='col p-4 d-flex justify-content-center'>
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col d-flex justify-content-center'>
                                <Link to={'/Registro-usuario'} className ="TextoValid3 text-center">Registrar profesor</Link>
                            </div>
                        </div>
