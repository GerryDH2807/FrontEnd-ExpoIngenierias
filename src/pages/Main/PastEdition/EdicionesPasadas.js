            ...
            <div className='row PasadosContainer m-3'>
                ...
                {Dirección === "Izquierda" && (
                    <>
                        ...
                        <div className={"col" + className+ Dirección}>
                            <img src={require('../../../img/' + FotoContenedor +".png")} alt="" className={'FotoContenedor'+Dirección}/>
                        </div>
