...
export default function DetailedAnnounCont(){
    return(
        <div className="container-fluid mt-3 p-3">
            ...
            <Link to={'/anuncios-estudiante'} className="row mt-4 p-3 ContainerAnnounBut ButtReturn d-flex justify-items-center">
                <Link to={'/anuncios-estudiante'} className="text-center ButtReturn">Regresar a anuncios</Link>
            </Link>       
        </div>
    );
}