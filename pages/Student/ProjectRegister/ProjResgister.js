      ...
      <Row className="mb-3">
        <Form.Group as={Col} md="12" controlId="validationMembers">
          ...
          <div className='container-fluid'>
            <div className='row'>
              <div className='col'>
                En esta sección solo deberas registrar a los integrantes de tu equipo. Al tu estar registrando el proyecto, te convertiras en el lider del equipo y ya serás considerado como miembro.
              </div>
            </div>
          </div>
...
export default function ProjRegisterCont(){
  return (
    <>
      <StudentToggle NameSection={"Registro de proyecto"}></StudentToggle>
